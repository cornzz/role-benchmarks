...
"%ANT_HOME%"\bin\ant jar -lib %dir%\objectteams\classic-3.8.0\ecotj-head.jar -Dlib=%dir%\objectteams\classic-3.8.0 -Dsource=14 -Dtarget=14 -Dver=3.8.0 -Dapr=classic -Dotredyn_ver=otredyn
pause